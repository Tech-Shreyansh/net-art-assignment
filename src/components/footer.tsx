...
function Footer () {
    return(
        <div className="flex flex-col md:flex-row bg-red-500 h-[12vh] md:h-[15vh] text-white text-xs md:text-base py-2 md:py-8 px-16 justify-center items-center space-y-2 md: space-y-0 justify-between">
